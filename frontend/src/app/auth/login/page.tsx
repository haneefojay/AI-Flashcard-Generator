  ...
  const googleLogin = useGoogleLogin({
    onSuccess: async (tokenResponse) => {
      try {
        ...
        // Exchange access token for ID token via backend or use directly
        ...
        <Card>
          ...
          <CardContent>
            ...
            <Button
              type="button"
              variant="outline"
              className="w-full mt-6 flex items-center justify-center gap-3 py-5 border-border hover:bg-primary/70"
              onClick={() => googleLogin()}
